...
--------------------------------------------------------------------------
(By Kyle Halek, https://github.com/LahkLeKey/QuantumPropagationIntervalNotebook)
...
"""
print("🚀 Quantum Meets Black Holes: Simulate and Visualize the Universe's Mysteries 🌌")
print("🔬 By Kyle Halek https://www.lahklekey.com/")
